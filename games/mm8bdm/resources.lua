...
function MM8BDM.make_cool_gfx()
  ...
  local colmaps =
  {
    ...
    MM8BDM.LEVEL_GFX_COLORS.gold,
    MM8BDM.LEVEL_GFX_COLORS.silver,
    MM8BDM.LEVEL_GFX_COLORS.iron,
  }
  ...
  gui.set_colormap(4, MM8BDM.LEVEL_GFX_COLORS.iron)
  gui.set_colormap(5, MM8BDM.LEVEL_GFX_COLORS.black)
...
function MM8BDM.make_level_gfx()
  -- decide color set
  if not GAME.level_gfx_colors then
    ...
    GAME.level_gfx_colors = assert(MM8BDM.LEVEL_GFX_COLORS[kind])
  end
...
function MM8BDM.make_episode_gfx()
  -- this is for Doom 1 / Ultimate MM8BDM.
  -- does nothing for Doom 2 / Final Doom (they lack "name_patch" field).

  local colors = assert(MM8BDM.LEVEL_GFX_COLORS["red"])
...
function MM8BDM.end_level()
  MM8BDM.make_level_gfx()
end


function MM8BDM.all_done()
  MM8BDM.make_cool_gfx()
  MM8BDM.make_episode_gfx()
